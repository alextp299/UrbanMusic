                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" v-if="isLoggedin">
                        ...
                        <div class="dropdown mt-3 me-1">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="width: 220px; position: absolute; left: -90px; height: auto; padding: 0;">
                                ...
                                <li class="nav-item">
                                    <router-link to="/admincanciones" class="nav-item nav-link mt-1 ms-3 fw-bold tamaño_letra" v-if="user.roles[0].rol === 'accederAdmin'">Administrador Canciones</router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/adminproductos" class="nav-item nav-link mt-1 ms-3 fw-bold tamaño_letra" v-if="user.roles[0].rol === 'accederAdmin'">Administrador Productos</router-link>
                                </li>
                                <li class="nav-item">
                                    <router-link to="/adminusers" class="nav-item nav-link mt-1 ms-3 fw-bold tamaño_letra" v-if="user.roles[0].rol === 'accederUserAdmin'">Administrador Usuarios</router-link>
                                </li>
                                <li class="nav-item fondo-color-logout">
                                    <router-link to="/" class="nav-item nav-link mt-1 ms-3 tamaño_session4" @click="logout">Logout</router-link>
                                </li>
